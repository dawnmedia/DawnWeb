...
showcase:
  ...
  audience: "Voyageurs qui planifient des trajets flexibles"
  ...
  stack:
    ...
    - "Paiements"
  primaryAction:
    label: "Planifiez Votre Voyage Maintenant"
    url: "/fr/contact"
  secondaryAction:
    label: "Discuter d'un produit voyage"
    url: "/fr/contact"
  metrics:
    - value: "IA"
      label: "Coeur de planification"
    - value: "4+"
